...
var kDown		= (mouse_wheel_down() || keyboard_check_pressed( vk_down ) || (keyboard_check_pressed(ord("2"))) );
var kUp			= (mouse_wheel_up() || keyboard_check_pressed( vk_up ) || (keyboard_check_pressed(ord("1"))) );
var kConfirm	= (mouse_check_button_pressed( mb_left ) || keyboard_check_pressed( vk_enter) || (keyboard_check_pressed(ord("3"))) );
